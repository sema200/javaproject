var surname = new InputPole(document.getElementById('surname'), 'input', function (e) {
    let checkChar = this.controlChar(new RegExp('[а-яА-Я]'), 15);
    checkChar(e, this.transLiteration);
});
var name = new InputPole(document.getElementById('name'), 'input', function (e) {
    let checkChar = this.controlChar(new RegExp('[а-яА-Я]'), 15);
    checkChar(e);
});
...
var unit = new InputPole(document.getElementById('unit'), 'input', function (e) {
    let checkChar = this.controlChar(new RegExp('[а-яА-Я]'), 25);
    checkChar(e);
});
var birth = new InputPole(document.getElementById('birth'), 'input', function (e) {
...
var email = new InputPole(document.getElementById('email'), 'input', function (e) {
